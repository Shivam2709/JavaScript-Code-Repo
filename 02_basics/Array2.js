...
const all_new_heros = [...marvel_heros, ...dc_heros] // spred operator is used to spred the values indivisually..
...
console.log(Array.isArray("Hitesh")) // checks if the passed value is an Array 
